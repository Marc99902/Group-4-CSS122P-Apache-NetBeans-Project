...
public class EmployeeDialog extends JDialog {
    ...
    private void initializeComponents() {
        ...
        DarkTheme.styleComboBox(typeComboBox);
        ...
        DarkTheme.styleComboBox(levelComboBox);
        ...
        managerPanel.setBackground(DarkTheme.BACKGROUND_DARK);
        managerPanel.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(DarkTheme.ACCENT_PRIMARY),
            "Manager Information",
            TitledBorder.LEFT,
            TitledBorder.TOP,
            DarkTheme.FONT_BOLD,
    ...
    private JTextField createStyledTextField() {
        ...
        DarkTheme.styleTextField(field);
        return field;
    }
    ...
    private void setupLayout() {
        ...
        mainPanel.setBackground(DarkTheme.BACKGROUND_DARK);
        mainPanel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));
        
        // Form panel with GridBagLayout
        JPanel formPanel = new JPanel(new GridBagLayout());
        formPanel.setBackground(DarkTheme.BACKGROUND_DARK);
        ...
        DarkTheme.styleButton(saveButton, "success");
        
        JButton cancelButton = new JButton("Cancel");
        DarkTheme.styleButton(cancelButton, "secondary");
    ...
    private void addFormRow(JPanel panel, GridBagConstraints gbc, int row, 
        ...
        label.setFont(DarkTheme.FONT_DEFAULT);
    ...
    private void setupManagerPanel() {
        ...
        teamLabel.setFont(DarkTheme.FONT_DEFAULT);
        teamLabel.setForeground(DarkTheme.FOREGROUND_PRIMARY);
        ...
        levelLabel.setFont(DarkTheme.FONT_DEFAULT);
        levelLabel.setForeground(DarkTheme.FOREGROUND_PRIMARY);
        ...
        bonusLabel.setFont(DarkTheme.FONT_DEFAULT);
        bonusLabel.setForeground(DarkTheme.FOREGROUND_PRIMARY);
    ...
    private void populateFields(Employee employee) {
        ...
        idField.setBackground(DarkTheme.BACKGROUND_LIGHT);
