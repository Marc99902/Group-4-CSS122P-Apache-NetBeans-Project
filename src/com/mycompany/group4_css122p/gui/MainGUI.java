 ...
 * employee records with a modern dark theme.
 * 
 * FEATURES:
...
public class MainGUI extends JFrame {
    ...
    private void initializeComponents() {
        ...
        DarkTheme.styleTable(employeeTable);
        ...
        DarkTheme.styleTextField(searchField);
        searchField.setToolTipText("Search by name...");
        
        // Filter dropdowns
        departmentFilter = new JComboBox<>();
        DarkTheme.styleComboBox(departmentFilter);
        ...
        DarkTheme.styleComboBox(statusFilter);
        
        // Status bar
        statusBar = new JLabel("Ready");
        statusBar.setFont(DarkTheme.FONT_SMALL);
        statusBar.setForeground(DarkTheme.FOREGROUND_MUTED);
    ...
    private void setupLayout() {
        ...
        topPanel.setBackground(DarkTheme.BACKGROUND_DARKEST);
        ...
        filterPanel.setBackground(DarkTheme.BACKGROUND_DARK);
        ...
        searchLabel.setForeground(DarkTheme.FOREGROUND_PRIMARY);
        filterPanel.add(searchLabel);
        filterPanel.add(searchField);
        
        JButton searchBtn = new JButton("Search");
        DarkTheme.styleButton(searchBtn, "primary");
        filterPanel.add(searchBtn);
        
        filterPanel.add(new JLabel("  "));  // Spacer
        
        JLabel deptLabel = new JLabel("Department:");
        deptLabel.setForeground(DarkTheme.FOREGROUND_PRIMARY);
        filterPanel.add(deptLabel);
        filterPanel.add(departmentFilter);
        
        JLabel statusLabel = new JLabel("Status:");
        statusLabel.setForeground(DarkTheme.FOREGROUND_PRIMARY);
        filterPanel.add(statusLabel);
        filterPanel.add(statusFilter);
        
        JButton clearBtn = new JButton("Clear");
        DarkTheme.styleButton(clearBtn, "secondary");
        ...
        centerPanel.setBackground(DarkTheme.BACKGROUND_DARKEST);
        
        // Table scroll pane
        JScrollPane tableScrollPane = new JScrollPane(employeeTable);
        DarkTheme.styleScrollPane(tableScrollPane);
        ...
        buttonPanel.setBackground(DarkTheme.BACKGROUND_DARK);
        ...
        actionsTitle.setFont(DarkTheme.FONT_HEADER);
        actionsTitle.setForeground(DarkTheme.FOREGROUND_PRIMARY);
        ...
        statusPanel.setBackground(DarkTheme.BACKGROUND_DARK);
        statusPanel.setBorder(BorderFactory.createLineBorder(DarkTheme.BORDER_COLOR));
    ...
    private JButton createActionButton(String text, String type) {
        ...
        DarkTheme.styleButton(button, type);
    ...
    private void viewEmployeeDetails() {
        ...
        if (employee != null) {
            ...
            textArea.setFont(DarkTheme.FONT_MONO);
            textArea.setBackground(DarkTheme.BACKGROUND_DARK);
            textArea.setForeground(DarkTheme.FOREGROUND_PRIMARY);
