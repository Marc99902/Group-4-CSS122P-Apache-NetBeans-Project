...
public class StatisticsDashboard extends JFrame {
    ...
    private void initializeComponents() {
        ...
        performanceChartPanel.setBackground(ProfessionalTheme.BACKGROUND_DARK);
        
        departmentChartPanel = new JPanel();
        departmentChartPanel.setBackground(ProfessionalTheme.BACKGROUND_DARK);
        
        // Top performers area
        topPerformersArea = new JTextArea(10, 30);
        topPerformersArea.setFont(ProfessionalTheme.FONT_MONO);
        topPerformersArea.setBackground(ProfessionalTheme.BACKGROUND_MEDIUM);
        topPerformersArea.setForeground(ProfessionalTheme.FOREGROUND_PRIMARY);
    ...
    private void setupLayout() {
        ...
        headerPanel.setBackground(ProfessionalTheme.BACKGROUND_DARKEST);
        ...
        ProfessionalTheme.styleButton(refreshBtn, "primary");
        ...
        splitPane.setBackground(ProfessionalTheme.BACKGROUND_DARKEST);
        ...
        footerPanel.setBackground(ProfessionalTheme.BACKGROUND_DARK);
        footerPanel.setBorder(BorderFactory.createLineBorder(ProfessionalTheme.BORDER_COLOR));
        
        JLabel footerLabel = new JLabel("Connected to Employee Management System");
        footerLabel.setFont(ProfessionalTheme.FONT_SMALL);
        footerLabel.setForeground(ProfessionalTheme.FOREGROUND_MUTED);
    ...
    private JPanel createLeftPanel() {
        ...
        panel.setBackground(ProfessionalTheme.BACKGROUND_DARKEST);
        ...
        wrapper.setBackground(ProfessionalTheme.BACKGROUND_DARKEST);
    ...
    private JPanel createMetricsPanel() {
        ...
        panel.add(createMetricCard("Total Employees", totalEmpValue, ProfessionalTheme.INFO));
        panel.add(createMetricCard("Total Managers", totalMgrValue, ProfessionalTheme.WARNING));
        panel.add(createMetricCard("Departments", totalDeptValue, ProfessionalTheme.SUCCESS));
        panel.add(createMetricCard("Average Rating", avgRatingValue, ProfessionalTheme.ACCENT_PRIMARY));
        panel.add(createMetricCard("Total Payroll", totalPayrollValue, ProfessionalTheme.SUCCESS));
        panel.add(createMetricCard("Average Salary", avgSalaryValue, ProfessionalTheme.INFO));
    ...
    private JPanel createMetricCard(String title, JLabel valueLabel, Color accentColor) {
        ...
        card.setBackground(ProfessionalTheme.BACKGROUND_DARK);
        ...
        titleLabel.setFont(ProfessionalTheme.FONT_DEFAULT);
    ...
    private JPanel createRightPanel() {
        ...
        topPerfPanel.setBackground(ProfessionalTheme.BACKGROUND_DARK);
        ...
        ProfessionalTheme.styleScrollPane(topPerfScroll);
    ...
    private JPanel createManagerStatsPanel() {
        ...
        panel.add(createStatusCard("EE (Exceeds)", eeCountValue, ProfessionalTheme.SUCCESS));
        panel.add(createStatusCard("ME (Meets)", meCountValue, ProfessionalTheme.WARNING));
        panel.add(createStatusCard("PIP (Improvement)", pipCountValue, ProfessionalTheme.DANGER));
        panel.add(createStatusCard("Highest Paid", highestPaidValue, ProfessionalTheme.ACCENT_PRIMARY));
    ...
    private void updatePerformanceChart(int eeCount, int meCount, int pipCount, int total) {
        ...
        if (total == 0) {
            ...
            noDataLabel.setForeground(ProfessionalTheme.FOREGROUND_MUTED);
        ...
        performanceChartPanel.add(createBar("EE (Exceeds)", eeCount, total, ProfessionalTheme.SUCCESS));
        performanceChartPanel.add(createBar("ME (Meets)", meCount, total, ProfessionalTheme.WARNING));
        performanceChartPanel.add(createBar("PIP (Improvement)", pipCount, total, ProfessionalTheme.DANGER));
    ...
    private JPanel createBar(String label, int value, int total, Color color) {
        ...
        barPanel.setBackground(ProfessionalTheme.BACKGROUND_DARK);
        ...
        titleLabel.setFont(ProfessionalTheme.FONT_SMALL);
        titleLabel.setForeground(ProfessionalTheme.FOREGROUND_SECONDARY);
        barPanel.add(titleLabel, BorderLayout.NORTH);
        
        // Bar container
        JPanel barContainer = new JPanel(new BorderLayout());
        barContainer.setBackground(ProfessionalTheme.BACKGROUND_MEDIUM);
        ...
        pctLabel.setFont(ProfessionalTheme.FONT_SMALL);
    ...
    private JPanel createDepartmentBar(String dept, int count, double percentage) {
        ...
        nameLabel.setFont(ProfessionalTheme.FONT_SMALL);
        nameLabel.setForeground(ProfessionalTheme.FOREGROUND_PRIMARY);
        ...
        progressBar.setBackground(ProfessionalTheme.BACKGROUND_MEDIUM);
        progressBar.setForeground(ProfessionalTheme.ACCENT_PRIMARY);
